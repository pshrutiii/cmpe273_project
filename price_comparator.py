...
def trips():
  if g.user:
      ...
      if(len(all_way_points_in_list) == 0):
          result1 = {}
          lyft_list = []
          uber_list = []
          a = lyft.get_route_metrics(origin_lat, origin_lng, destination_lat, destination_lng)
          lyft_list.append(a)
          p = uber.get_route_metrics(origin_lat, origin_lng, destination_lat, destination_lng)
          uber_list.append(p)
      ...
      if (len(all_way_points_in_list) == 1):
          ...
          lyft_list=[]
          uber_list=[]
          a = lyft.get_route_metrics(origin_lat, origin_lng, waypoint1_lat, waypoint1_lng)
          lyft_list.append(a)
          b = lyft.get_route_metrics(waypoint1_lat, waypoint1_lng, destination_lat, destination_lng)
          lyft_list.append(b)

          p = uber.get_route_metrics(waypoint1_lat, waypoint1_lng, destination_lat, destination_lng)
          uber_list.append(p)
          q = uber.get_route_metrics(waypoint1_lat, waypoint1_lng, destination_lat, destination_lng)
          uber_list.append(q)
    ...
    # origin -> waypoint1 -> waypoint3 -> waypoint2 -> destination
      ...
      if(len(all_way_points_in_list) == 0):
      ...
      elif (len(all_way_points_in_list) == 1):
          finalcost = result1['Lyft Plus']['cost']
          final_result_metrics = result1
          ...
          result1cost = result1['Lyft Plus']['cost']
          result2cost = result2['Lyft Plus']['cost']
          result3cost = result3['Lyft Plus']['cost']
          result4cost = result4['Lyft Plus']['cost']
          result5cost = result5['Lyft Plus']['cost']
          result6cost = result6['Lyft Plus']['cost']
          list_of_cost = []
          list_of_cost.append(result1cost)
          list_of_cost.append(result2cost)
          list_of_cost.append(result3cost)
          list_of_cost.append(result4cost)
          list_of_cost.append(result5cost)
          list_of_cost.append(result6cost)

          list_of_cost.sort()

          if(result1cost == list_of_cost[0]):
              final_result_metrics = result1
          elif(result2cost == list_of_cost[0]):
              final_result_metrics = result2
          elif (result3cost == list_of_cost[0]):
              final_result_metrics = result3
          elif (result4cost == list_of_cost[0]):
              final_result_metrics = result4
          elif (result5cost == list_of_cost[0]):
              final_result_metrics = result5
          elif (result6cost == list_of_cost[0]):
              final_result_metrics = result6
      ...
      #print calculated_route #avdeep leg vala
      ...
      if(jsdata == "minprice"):
        result_metrics = final_result_metrics

      elif(jsdata == "mindistance"):
